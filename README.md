...
<head>
    ...
    <style>
        ...
        #loading-screen {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(135deg, #4a00e0, #8e2de2); /* Beautiful Purple Gradient */
            display: flex;
...
<body>
        ...
        <main class="content">
            ...
            <section id="withdraw-page" class="page">
                <div class="card">
                    ...
                    <p style="font-size: 13px; color: #666; margin: 5px 0;">Minimum Withdraw: <b>৳ 100</b></p>
                ...
                <div class="card" style="text-align: left;">
                    <form id="withdraw-form">
                        ...
                        <input type="number" id="amount" placeholder="Enter Amount (Min 100)" min="100" required>
    ...
    <script>
        ...
        const STORE_KEY = 'bd_income_bot_v4';
        ...
        window.onload = function() {
            ...
            // Wait for 3 seconds to show the beautiful loading animation
            setTimeout(() => {
                ...
                // --- In-App Interstitial Logic (Corrected) ---
        ...
        document.getElementById('withdraw-form').addEventListener('submit', (e) => {
            ...
            tg.showConfirm(`Confirm Withdraw ৳${amount} to ${number}?`, (ok) => {
                if (ok) {
...
`;
                    ...
                    .then(data => {
                        if(data.ok) {
                            ...
                            state.balance += amount;
                            saveData();
                            tg.showAlert('Failed to send request.');
                        }
                    })
                    .catch(err => {
                        state.balance += amount;
