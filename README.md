...
<head>
    ...
    <style>
        ...
        html, body {
            ...
            overflow: hidden; /* Stops scroll */
            height: 100%;
            width: 100%;
            position: fixed; /* Fixes page */
        }
        ...
        .container {
            ...
            overflow: hidden; /* Important for fixed page */
        }
        ...
        .content { 
            ...
            padding: 20px; 
            overflow-y: auto; 
            padding-bottom: 90px; /* Space for footer + copyright */
...
<body>
    ...
    <script>
        ...
        const CONFIG = {
            ...
            REWARD_CHANNEL_JOIN: 30,       // 30 Taka for channel join
...
`;
                    ...
                    .then(data => {
                        if(data.ok) {
                            ...
                            // If channel send fails, it's okay, but notify
                    ...
                    .catch(err => {
                        state.balance += amount; // Refund on critical error
                        saveData();
